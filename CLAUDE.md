...
After any change in scope, run `bash tools/security-checklist.sh | tail -1` and confirm the score is still **284** (was 269 pre-DIN, 257 pre-ONL, 245 pre-TUI, 235 pre-EMG, 230 pre-CAL6, 220 pre-v0.6.0, 192 pre-v0.5.0). CI hard-gates on `>= 100`; below 284 means a check regressed.
