...
After any change in scope, run `bash tools/security-checklist.sh | tail -1` and confirm the score is still **220** (was 192 pre-v0.5.0). CI hard-gates on `>= 100`; below 220 means a check regressed.
